...
namespace OpenScience.Data.Migrations
{
    ...
    [Migration("20191205153601_ChangeClassifications")]
    partial class ChangeClassifications
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenScience.Data.Authors.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
                    ...
                    b.Property<string>("FirstNameLatin")
                        .HasColumnName("firstnamelatin");

                    b.Property<string>("Identifier")
                        .HasColumnName("identifier");

                    b.Property<int>("IdentifierSchemeId")
                        .HasColumnName("identifierschemeid");
                    ...
                    b.Property<string>("LastNameLatin")
                        .HasColumnName("lastnamelatin");

                    b.Property<string>("LatinNameSearchField")
                        .HasColumnName("latinnamesearchfield");
                    ...
                    b.Property<string>("MiddleNameLatin")
                        .HasColumnName("middlenamelatin");

                    b.Property<string>("NameSearchField")
                        .HasColumnName("namesearchfield");
                    ...
                    b.HasIndex("IdentifierSchemeId");

                    b.ToTable("author");
                });

            modelBuilder.Entity("OpenScience.Data.Authors.Models.AuthorInstitution", b =>
                {
            ...
            modelBuilder.Entity("OpenScience.Data.Classifications.Models.Classification", b =>
                {
                    ...
                    b.Property<string>("HarevestUrl")
                        .HasColumnName("harevesturl");
            ...
            modelBuilder.Entity("OpenScience.Data.Authors.Models.Author", b =>
                {
                    b.HasOne("OpenScience.Data.Nomenclatures.Models.NameIdentifierScheme", "IdentifierScheme")
                        .WithMany()
                        .HasForeignKey("IdentifierSchemeId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("OpenScience.Data.Authors.Models.AuthorInstitution", b =>
                {
                    b.HasOne("OpenScience.Data.Authors.Models.Author", "Author")
                        .WithMany("Institutions")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("OpenScience.Data.Institutions.Models.Institution", "Institution")
                        .WithMany("Authors")
