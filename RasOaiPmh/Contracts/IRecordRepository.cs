...
namespace NacidRas.Integrations.OaiPmhProvider.Contracts
{
    ...
    public interface IRecordRepository
    {
		...
		ListContainer<Record> GetRecords(ArgumentContainer arguments, ResumptionToken resumptionToken = null);
		...
		ListContainer<Record> GetIdentifiers(ArgumentContainer arguments, ResumptionToken resumptionToken = null);
    }
}
